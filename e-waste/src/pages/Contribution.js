...
import search from './search.png'
 ...
 import plant from './WhatsApp_Image_2023-09-19_at_01.24.14-removebg-preview.png'
...
<p className='text-[1.3rem] text-[white] hover:cursor-pointer hover:opacity-[60%]'>Download</p>
        ...
        <div>
        <div>
            <p className='text-[1.6rem] w-[60%] ml-[9rem] pr-[0rem] mt-[2rem]'>Your plant is will be planted on this location on 26 January 2024. Please visit our site after sometime to track your tree growth.</p>
        </div>
